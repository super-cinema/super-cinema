...
@AllArgsConstructor
public class MovieFacadeAg {

    private MovieRepository movieRepository;
    private MovieBuilderServiceAg movieBuilderServiceAg;

    public MovieDto saveMovie(MovieDto movieDto) {
        Movie movie = movieBuilderServiceAg.entityFromDto(movieDto);
        movieRepository.save(movie);
        return movieBuilderServiceAg.dtoFromEntity(movie);
    }
    ...
    public MovieDto getMovieById(Long id) throws EntityNotFoundException {
        ...
        MovieDto movieDto = movieBuilderServiceAg.dtoFromEntity(movie);
        return movieDto;
    }
    ...
    public List<MovieDto> getAllMovies() {
        ...
        if(!allMovies.isEmpty()){
            for(Movie movie : allMovies) {
                allMoviesDto.add(movieBuilderServiceAg.dtoFromEntity(movie));
            }
        }
        return allMoviesDto;
    }
